...
INSERT INTO `website_cooperativeuser` VALUES ('6c348578-6fc4-49d1-bead-16bbe564f613', '湖北能源集团股份有限公司', '/upload/7cdbdf83-fe8b-4f6c-a5ab-59279abcad79.jpg', '1', '2019-01-24 16:15:40');
...
INSERT INTO `website_dowhat` VALUES ('e9b7c8b9-738d-4291-83c6-b21f90fdee75', '/upload/4ad2575f-3db0-4c2c-a2e3-37cb0bc813dc.png', '通用组态', '/product', '1', '2019-01-24 16:15:28');
...
INSERT INTO `website_golden` VALUES ('2d5b9532-2f44-4ce8-a0c1-52497cecf94a', '庚顿数据输出适配器', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;庚顿数据输出适配器提供将实时数据库中采集到的数据以窄表、宽表模式实时输出到后端的各种管理及分析平台，为企业进行及时决策，快速管理，为数据的充分挖掘分析提供关键性支撑。庚顿数据输出适配器是一个开放的，具有高度可扩展、可配置式的插件管理系统。对应当前主流的数据管理和分析平台，输出适配器目前可以将数据灵活输出到Hadoop大数据平台以及Oracle、MySql、SqlServer等关系数据库中。&nbsp;&nbsp;<br></p>', '31', '2', null, '2019-01-24 16:15:22');
INSERT INTO `website_golden` VALUES ('37d0add5-e027-404b-a6fd-568add4f549f', '智能电网', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;以信息化、自动化、互动化为特征的智能电网在发电、输电、变电、配电、用电和调度六个环节产生海量数据。这些数据是智能电网的重要基础。</p><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;基于实时数据库建立的海量实时/历史数据管理平台，可以满足智能电网各业务应用对海量实时/历史数据进行整合、存储、共享、统一访问的需求。</div><p><img src=\'/upload/d4a7b168-3be6-4c04-b31f-b0de3652a73c.png\'><br></p>', '36', '4', '/upload/277c4fb2-fc3b-45aa-97dd-1c426b967736.jpg', '2018-12-28 14:37:17');
...
INSERT INTO `website_industrycase` VALUES ('af0e923b-5e51-4f34-8986-34e18e7a34d1', '金风科技', '/upload/2e1fbaaa-22c9-4643-a1f5-6feac30abdad.jpg', '/solution', '1', '2019-01-24 16:15:36');
...
-- ----------------------------
INSERT INTO `website_invoice` VALUES ('b65ce94f-b3ed-43a1-a8aa-dabbc50227e0', '1', '111111111111111', '15501501611', '北京银行天坛支行', '12345678', '2019-01-17 09:17:51');
...
INSERT INTO `website_lunbotu` VALUES ('e2253aa3-3973-46a2-942f-3baa8692b258', '庚顿时序数据库', '/upload/e6d4c4e7-46b4-468c-8c87-dd2d5a375128.jpg', '/solution', '1', '2019-01-24 15:56:22');
...
-- ----------------------------
-- Table structure for website_productbuyinfo
-- ----------------------------
DROP TABLE IF EXISTS `website_productbuyinfo`;
CREATE TABLE `website_productbuyinfo` (
  `id` varchar(36) COLLATE utf8_bin NOT NULL,
  `title` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '产品名称',
  `content` varchar(4096) COLLATE utf8_bin DEFAULT NULL COMMENT '产品简介',
  `order` int(1) DEFAULT NULL COMMENT '展示顺序',
  `imgpath` varchar(60) COLLATE utf8_bin DEFAULT NULL COMMENT '图片路径',
  `parameter` varchar(2048) COLLATE utf8_bin DEFAULT NULL COMMENT '产品参数',
  `price` varchar(4096) COLLATE utf8_bin DEFAULT NULL COMMENT '产品价格',
  `details` varchar(512) COLLATE utf8_bin DEFAULT NULL COMMENT '产品详情',
  `notice` varchar(512) COLLATE utf8_bin DEFAULT NULL COMMENT '购买须知',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of website_productbuyinfo
-- ----------------------------
INSERT INTO `website_productbuyinfo` VALUES ('fdde25b0-90ec-4562-bcf1-76e36e46c4c5', '庚星时序数据库管理系统V3.0', '庚星时序数据库是依托于工业实时数据库面向物联网领域推出的一款基于Windows平台时序数据库，具备采集、控制和管理传感器数据查询、存储海量时序/历史数据的功能，能实现物联网领域终端用户和设备的连接，管理物联网领域用户和设备的智能交互。开放的、可扩展的结构可满足用户构建各种企业级应用的需求。庚星时序数据库提供丰富的二次开发接口，可方便用户构建各类应用系统。', '1', '/upload/8e1a61c0-6640-405e-a738-6809fa63f8e6.jpg', '<p><span>系统类型：windows</span></p><p><span>基础系统版本：Windows server 2016 X86(X64) 中文版</span></p><p><span>集成服务组件及版本：庚星时序数据库管理系统(GoldenStarDB)V3.0</span></p>', '<table border=\"0\" width=\"100%\"><tbody><tr><th> 规格</th><th>周期 </th><th> 价格</th><th>续费价格 </th></tr><tr><td> \r\n\r\n1000点</td><td> 单次</td><td> \r\n\r\n5000</td><td> -</td></tr><tr><td> \r\n\r\n2000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n10000</td><td> -</td></tr><tr><td> \r\n\r\n3000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n15000</td><td> -</td></tr><tr><td> \r\n\r\n5000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n20000</td><td> -</td></tr><tr><td> \r\n\r\n8000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n28000</td><td> -</td></tr><tr><td> \r\n\r\n10000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n30000</td><td> -</td></tr><tr><td> \r\n\r\n20000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n48000</td><td> -</td></tr><tr><td> \r\n\r\n30000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n62000</td><td> -</td></tr><tr><td> \r\n\r\n50000点</td><td> \r\n\r\n单次</td><td> \r\n\r\n75000</td><td> -</td></tr></tbody></table><p><br></p>', '<p><img src=\"/upload/17a139cd-dfd4-434d-a399-93f06c42261b.png\"><br></p>', '<p>有问题请联系在线客服进行沟通，或扫描下方微信公众号二维码关注，也可拨打免费热线：400-628-5226 ，及时了解最新产品信息  <br></p>', '2019-01-21 14:07:59', 'superadmin');
...
INSERT INTO `website_user` VALUES ('b65ce94f-b3ed-43a1-a8aa-dabbc50227e0', 'forlong', '0', '0', '2019-01-14 11:15:35', '1', '测试', '0');
